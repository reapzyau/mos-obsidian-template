...
// Same hide rules as .obsidian/snippets/hide-claude-code-items.css — keep in sync.
const HIDDEN_NAMES = new Set(['README.md', 'CLAUDE.md', 'AGENTS.md', 'scripts', 'runs', 'node_modules']);
const HIDDEN_ROOT = new Set(['MEMORY', 'Plans', 'design-system', 'graphify-out', 'REFERENCES.md', 'CONTEXT.md',
  'AGENTS.local-pre-pull-2026-07-22.md', 'GRAPH_CONTRACT.md', 'PRODUCT.md']);
